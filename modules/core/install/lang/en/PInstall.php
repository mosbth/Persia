...
$lang = Array(
	'INSTALL_PAGE_TITLE' => "Install database",
	'INSTALL_HEADER' => "Install database",
	'INSTALL_DESCRIPTION' => "Click below link to remove all contents from the database and create new tables and content from scratch.",
