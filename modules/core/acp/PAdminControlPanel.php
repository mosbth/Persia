...
//
// File: PAdminControlPanel.php
//
// Description: First page for Admin Control Panel (acp). Display menu.
//
...
//
CHTMLPage::GetInstance()->PrintPage(sprintf($pc->lang['ACP_FOR'], $uc->GetAccountName()), $htmlLeft, $htmlMain, $htmlRight);
exit;
