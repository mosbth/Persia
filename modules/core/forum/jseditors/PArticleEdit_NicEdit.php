...
// ===========================================================================================
//
// PArticleEdit_NicEdit.php
//
// Testing the JavaScript editor NicEdit from http://nicedit.com/
//
...
<!-- Updated for NiceEditor ============================================================= -->
<script src="{$tpJavaScript}/nicedit/nicEdit.js" type="text/javascript"></script>
<script type="text/javascript">bkLib.onDomLoaded(nicEditors.allTextAreas);</script>
<!-- ==================================================================================== -->


<form class='editor1' action='?p=article-save' method='POST'>
<input type='hidden' name='redirect_on_success' value='article-nicedit&amp;article-id=%1\$d'>
<input type='hidden' name='redirect_on_failure' value='article-nicedit&amp;article-id=%1\$d'>
...
<!-- Updated for NiceEditor ============================================================= -->
<textarea class='size500x400' id='content' name='content'>{$content}</textarea>
<!-- ==================================================================================== -->
</p>
<p class="notice">
Saved: {$saved}
...
<p class='small'>
Current editor is: NicEdit (<a href='http://nicedit.com/'>http://nicedit.com/</a>)
</p>
<p class='small'>
Edit this using 
